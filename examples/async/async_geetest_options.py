...
solver = AsyncTwoCaptcha(api_key, defaultTimeout=300, pollingInterval=10, extendedResponse=True)
...
async def solve_captcha():
    # Get the challenge - we keep this synchronous since it's just setup
