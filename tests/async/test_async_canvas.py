...
class AsyncCanvasTest(AsyncAbstractTest):
    def test_file_param(self):
        ...
        self.send_return(sends, self.solver.canvas, file=file, hintText=hint)
    ...
    def test_base64_param(self):
        ...
        self.send_return(sends, self.solver.canvas, file=b64, hintText=hint)
    ...
    def test_all_params(self):
        ...
        self.send_return(sends, self.solver.canvas, file=file, **params)

    def test_not_found(self):
        self.invalid_file(self.solver.canvas, hintText=hint)
